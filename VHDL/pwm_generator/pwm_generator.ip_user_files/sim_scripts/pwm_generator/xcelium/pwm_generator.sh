...
#
# Script generated by Vivado on Wed Apr 09 10:52:17 CEST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : pwm_generator.sh
...
#
# Usage        : pwm_generator.sh
#                pwm_generator.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pwm_generator.sh [-reset_run]
#                pwm_generator.sh [-reset_log]
#                pwm_generator.sh [-help]
#
...
#                script (type 'pwm_generator.sh -help' for more information).
#
...
design_libs_elab="-libname xlconstant_v1_1_9 -libname xil_defaultlib -libname xlconcat_v2_1_6 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xlconstant_v1_1_9 xil_defaultlib xlconcat_v2_1_6)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "pwm_generator.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pwm_generator.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.pwm_generator xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.pwm_generator -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jrm/git/pan_tilt_control_system/VHDL/pwm_generator/pwm_generator.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log pwm_generator_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pwm_generator.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pwm_generator.sh [-help]\n\
Usage: pwm_generator.sh [-step]\n\
Usage: pwm_generator.sh [-lib_map_path]\n\
Usage: pwm_generator.sh [-reset_run]\n\
Usage: pwm_generator.sh [-reset_log]\n\
Usage: pwm_generator.sh [-keep_index]\n\
Usage: pwm_generator.sh [-noclean_files]\n\n\
