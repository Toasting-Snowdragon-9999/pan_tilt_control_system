...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xlconstant_v1_1_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot pwm_generator xil_defaultlib.pwm_generator xil_defaultlib.glbl -log elaborate.log
}
