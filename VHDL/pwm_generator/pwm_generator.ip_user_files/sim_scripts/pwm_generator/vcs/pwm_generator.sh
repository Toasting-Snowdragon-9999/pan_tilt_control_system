...
design_libs=(xlconstant_v1_1_9 xil_defaultlib xlconcat_v2_1_6)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pwm_generator xil_defaultlib.glbl -o pwm_generator_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pwm_generator_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/jrm/git/pan_tilt_control_system/VHDL/pwm_generator/pwm_generator.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key pwm_generator_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc pwm_generator_simv.daidir vcs_lib c.obj)
