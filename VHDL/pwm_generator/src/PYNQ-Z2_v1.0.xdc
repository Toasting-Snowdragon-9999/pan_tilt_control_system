...
#set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33} [get_ports clk]
#create_clock -add -name sys_clk_pin -period 100000.000 -waveform {0 50000} [get_ports { clk }];

## System clock on 125 MHz
set_property -dict {PACKAGE_PIN H16  IOSTANDARD LVCMOS33} [get_ports clk]
...
set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { ja_6 }]; #IO_L22P_T3_34 Sch=ja_p[4]
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { ja_7 }]; #IO_L22N_T3_34 Sch=ja_n[4] Garbage pin for now
...
set_property -dict { PACKAGE_PIN V6    IOSTANDARD LVCMOS33 } [get_ports { IN2_A }]; #IO_L22P_T3_13 Sch=rpio_14_r (PIN 8 RASPB_PI_HEADER)
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33 } [get_ports { IN1_A}]; #IO_L13N_T2_MRCC_13 Sch=rpio_15_r (PIN 10 RASPB_PI_HEADER)
...
set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { EN_A }]; #IO_L14P_T2_SRCC_13 Sch=rpio_21_r (PIN 40 RASPB_PI_HEADER)
...
#set_property -dict { PACKAGE_PIN P20   IOSTANDARD TMDS_33  } [get_p    orts { hdmi_rx_d_n[2] }]; #IO_L14N_T2_SRCC_34 Sch=hdmi_rx_d_n[2]
