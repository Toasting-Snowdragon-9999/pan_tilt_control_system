...
#                script (type 'even_parity_checker.sh -help' for more information).
#
...
design_libs_elab="-libname xil_defaultlib -libname xlslice_v1_0_4 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xil_defaultlib xlslice_v1_0_4)
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.even_parity_checker xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.even_parity_checker -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log even_parity_checker_sc.so .tmp_log xcelium_lib waves.shm c.obj)
