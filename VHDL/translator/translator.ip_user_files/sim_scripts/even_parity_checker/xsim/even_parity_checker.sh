...
#
# Script generated by Vivado on Wed Apr 23 13:37:44 CEST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : even_parity_checker.sh
...
#
# Usage        : even_parity_checker.sh
#                even_parity_checker.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                even_parity_checker.sh [-reset_run]
#                even_parity_checker.sh [-reset_log]
#                even_parity_checker.sh [-help]
#
...
export RDI_DATADIR="/tools/Xilinx/New_Full_Download/Vivado/2024.2/data"
...
# script info
echo -e "even_parity_checker.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./even_parity_checker.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xlslice_v1_0_4 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot even_parity_checker xil_defaultlib.even_parity_checker xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim even_parity_checker -key {Behavioral:sim_1:Functional:even_parity_checker} -tclbatch cmd.tcl -protoinst "protoinst_files/even_parity_checker.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/tools/Xilinx/New_Full_Download/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb even_parity_checker.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./even_parity_checker.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: even_parity_checker.sh [-help]\n\
Usage: even_parity_checker.sh [-step]\n\
Usage: even_parity_checker.sh [-lib_map_path]\n\
Usage: even_parity_checker.sh [-reset_run]\n\
Usage: even_parity_checker.sh [-reset_log]\n\
Usage: even_parity_checker.sh [-keep_index]\n\
Usage: even_parity_checker.sh [-noclean_files]\n\n\
