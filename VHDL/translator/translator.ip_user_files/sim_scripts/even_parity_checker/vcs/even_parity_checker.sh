...
design_libs=(xil_defaultlib xlslice_v1_0_4)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.even_parity_checker xil_defaultlib.glbl -o even_parity_checker_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./even_parity_checker_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key even_parity_checker_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc even_parity_checker_simv.daidir vcs_lib c.obj)
