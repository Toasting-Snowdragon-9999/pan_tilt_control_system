...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xlconstant_v1_1_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot movement_interpreter xil_defaultlib.movement_interpreter xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim movement_interpreter -key {Behavioral:sim_1:Functional:movement_interpreter} -tclbatch cmd.tcl -protoinst "protoinst_files/movement_interpreter.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb movement_interpreter.wdb xsim.dir libdpi.so)
