...
#
# Script generated by Vivado on Wed Mar 26 15:48:02 CET 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : movement_interpreter.sh
...
#
# Usage        : movement_interpreter.sh
#                movement_interpreter.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                movement_interpreter.sh [-reset_run]
#                movement_interpreter.sh [-reset_log]
#                movement_interpreter.sh [-help]
#
...
#                script (type 'movement_interpreter.sh -help' for more information).
#
...
design_libs_elab="-libname xil_defaultlib -libname xlconstant_v1_1_9 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xil_defaultlib xlconstant_v1_1_9)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "movement_interpreter.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./movement_interpreter.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.movement_interpreter xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.movement_interpreter -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log movement_interpreter_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./movement_interpreter.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: movement_interpreter.sh [-help]\n\
Usage: movement_interpreter.sh [-step]\n\
Usage: movement_interpreter.sh [-lib_map_path]\n\
Usage: movement_interpreter.sh [-reset_run]\n\
Usage: movement_interpreter.sh [-reset_log]\n\
Usage: movement_interpreter.sh [-keep_index]\n\
Usage: movement_interpreter.sh [-noclean_files]\n\n\
