...
design_libs=(xil_defaultlib xlconstant_v1_1_9)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.movement_interpreter xil_defaultlib.glbl -o movement_interpreter_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./movement_interpreter_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key movement_interpreter_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc movement_interpreter_simv.daidir vcs_lib c.obj)
