...
HD_PWD='C:/Users/chris/git/pan_tilt_control_system/VHDL/sensor_feedback/hall_sensor/hall_sensor.runs/read_sensor_advanced_compare_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log read_sensor_advanced_compare_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source read_sensor_advanced_compare_0_0.tcl
