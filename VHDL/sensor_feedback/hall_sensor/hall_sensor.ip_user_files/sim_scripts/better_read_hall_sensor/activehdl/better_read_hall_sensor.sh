...
#                script (type 'better_read_hall_sensor.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/chris/git/pan_tilt_control_system/VHDL/sensor_feedback/hall_sensor/hall_sensor.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
