...
#
# Script generated by Vivado on Thu Mar 13 16:14:24 +0100 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : better_read_hall_sensor.sh
...
#
# Usage        : better_read_hall_sensor.sh
#                better_read_hall_sensor.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                better_read_hall_sensor.sh [-reset_run]
#                better_read_hall_sensor.sh [-reset_log]
#                better_read_hall_sensor.sh [-help]
#
...
# script info
echo -e "better_read_hall_sensor.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./better_read_hall_sensor.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlconstant_v1_1_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot better_read_hall_sensor xil_defaultlib.better_read_hall_sensor xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim better_read_hall_sensor -key {Behavioral:sim_1:Functional:better_read_hall_sensor} -tclbatch cmd.tcl -protoinst "protoinst_files/better_read_hall_sensor.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb better_read_hall_sensor.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./better_read_hall_sensor.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: better_read_hall_sensor.sh [-help]\n\
Usage: better_read_hall_sensor.sh [-step]\n\
Usage: better_read_hall_sensor.sh [-lib_map_path]\n\
Usage: better_read_hall_sensor.sh [-reset_run]\n\
Usage: better_read_hall_sensor.sh [-reset_log]\n\
Usage: better_read_hall_sensor.sh [-keep_index]\n\
Usage: better_read_hall_sensor.sh [-noclean_files]\n\n\
