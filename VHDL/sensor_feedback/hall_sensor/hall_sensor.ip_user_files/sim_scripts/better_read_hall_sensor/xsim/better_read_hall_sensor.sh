...
#
# Script generated by Vivado on Wed May 14 09:46:55 +0200 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot better_read_hall_sensor xil_defaultlib.better_read_hall_sensor -log elaborate.log
}
